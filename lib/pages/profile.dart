...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadStats() async {
    try {
      final stats = await ApiService.fetchUserStats(widget.user.id);
      setState(() {
  ...
  String get _initials => widget.user.fullName
      .trim()
      .split(' ')
    ...
    Navigator.pushAndRemoveUntil(
      ...
      MaterialPageRoute(
        builder: (context) => const Scaffold(
          body: SafeArea(child: LoginnWidget()),
        ),
      ),
      (route) => false,
    );
        ...
        bottomNavigationBar: Container(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                icon: Icon(_selectedIndex == 1 ? Icons.assessment_rounded : Icons.assessment_outlined),
                label: 'Reports',
              ),
              BottomNavigationBarItem(
              ...
              BottomNavigationBarItem(
                icon: Icon(_selectedIndex == 3 ? Icons.map_rounded : Icons.map_outlined),
                label: 'Maps',
              ),
              BottomNavigationBarItem(
                icon: Icon(_selectedIndex == 4 ? Icons.person_rounded : Icons.person_outline_rounded),
                label: 'Profile',
              ),
            ],
          ),
              ...
              children: [
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.settings_rounded, color: AppTheme.primaryBlue, size: 22),
                        ),
                      ),
                    ],
                  ),
                ...
                Center(
                  child: Column(
                    children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: AppTheme.primaryBlue.withOpacity(0.3), blurRadius: 16, offset: const Offset(0, 4)),
                              ],
                            ),
                            child: CircleAvatar(
                              radius: 40,
                      ...
                      Text(
                        '${widget.user.roleName ?? 'Resident'} • ${widget.user.barangayName ?? 'N/A'}',
                ...
                Padding(
                  ...
                  child: _isLoading
                      ...
                      : Row(
                          children: [
                            Expanded(child: statCard(_totalReports.toString(), "TOTAL REPORTS", AppTheme.primaryBlue)),
                            const SizedBox(width: 14),
                            Expanded(child: statCard(_verified.toString(), "VERIFIED", AppTheme.successGreen)),
                          ],
                        ),
                ),
                ...
                infoTile(Icons.email_outlined, "Email Address", widget.user.email ?? 'N/A'),
                const SizedBox(height: 10),
                infoTile(Icons.phone_android, "Mobile Number", widget.user.mobileNumber ?? 'N/A'),
  ...
  Widget statCard(String number, String label, Color color) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(number, style: GoogleFonts.outfit(fontSize: 26, fontWeight: FontWeight.bold, color: color)),
          const SizedBox(height: 4),
          Text(
            label,
            style: GoogleFonts.outfit(fontSize: 10, color: Colors.grey.shade600, fontWeight: FontWeight.w500),
  ...
  Widget sectionTitle(String title) {
    return Padding(
      ...
      child: Text(
        title,
        style: GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.grey.shade600, letterSpacing: 0.5),
      ),
    );
  }
  ...
  Widget infoTile(IconData icon, String title, String subtitle) {
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text(subtitle, style: GoogleFonts.outfit(color: Colors.grey.shade600, fontSize: 13)),
